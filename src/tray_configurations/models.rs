...
pub struct Model {
    ...
    pub associated_experiments: Vec<crate::experiments::models::Experiment>,
}

#[derive(Copy, Clone, Debug, EnumIter, DeriveRelation)]
pub enum Relation {
    #[sea_orm(has_many = "crate::experiments::models::Entity")]
    Experiments,
    #[sea_orm(has_many = "crate::tray_configurations::trays::models::Entity")]
    Trays,
}
...
pub async fn get_one_tray_configuration(
    ...
    let results = Entity::find_by_id(id)
        .find_with_related(crate::tray_configurations::trays::models::Entity)
        .all(db)
        .await?;
    ...
    let experiments: Vec<crate::experiments::models::Experiment> =
        crate::experiments::models::Entity::find()
            .filter(crate::experiments::models::Column::TrayConfigurationId.eq(id))
            .all(db)
            .await?
            .into_iter()
            .map(Into::into)
...
pub async fn update_tray_configuration(
    ...
    if !trays.is_empty() {
        // Remove old trays
        crate::tray_configurations::trays::models::Entity::delete_many()
            .filter(crate::tray_configurations::trays::models::Column::TrayConfigurationId.eq(id))
            .exec(db)
            .await?;
