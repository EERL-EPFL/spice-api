...
use axum::{body::Body, http::{StatusCode, header::{CONTENT_TYPE, CONTENT_DISPOSITION}}, response::Response};
use tokio::sync::mpsc;
use futures::stream::{StreamExt, FuturesUnordered};

pub async fn create_hybrid_streaming_zip_response(
    assets: Vec<super::super::models::Model>,
    ...
    Ok(Response::builder()
        ...
        .header(CONTENT_DISPOSITION, 
                format!("attachment; filename=\"bulk-assets-{}.zip\"", 
