...
CREATE TYPE public.sample_type AS ENUM ('bulk', 'filter', 'blank');
...
CREATE INDEX idx_campaign_id ON public.campaign USING btree (id)
WITH
	(FILLFACTOR = 90);
...
CREATE INDEX idx_campaign_name ON public.campaign USING btree (name)
WITH
	(FILLFACTOR = 90);
...
CREATE TABLE
	public.tray_configuration_assignments (
		tray_id uuid NOT NULL,
...
ALTER TABLE public.samples ADD CONSTRAINT samples_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.campaign (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.experiments ADD CONSTRAINT fk_experiment_tray_configuration FOREIGN KEY (tray_configuration_id) REFERENCES public.tray_configurations (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ddl-end --
-- object: wells_tray_id_fkey | type: CONSTRAINT --
-- ALTER TABLE public.wells DROP CONSTRAINT IF EXISTS wells_tray_id_fkey CASCADE;
ALTER TABLE public.wells ADD CONSTRAINT wells_tray_id_fkey FOREIGN KEY (tray_id) REFERENCES public.trays (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.temperature_probes ADD CONSTRAINT temperature_probes_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiments (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.well_temperatures ADD CONSTRAINT well_temperatures_well_id_fkey FOREIGN KEY (well_id) REFERENCES public.wells (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.treatments ADD CONSTRAINT sample_treatments FOREIGN KEY (sample_id) REFERENCES public.samples (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.regions ADD CONSTRAINT regions_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiments (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.regions ADD CONSTRAINT regions_treatment_id_fkey FOREIGN KEY (treatment_id) REFERENCES public.treatments (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.freezing_results ADD CONSTRAINT freezing_results_well_id_fkey FOREIGN KEY (well_id) REFERENCES public.wells (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.freezing_results ADD CONSTRAINT freezing_results_region_id_fkey FOREIGN KEY (region_id) REFERENCES public.regions (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.inp_concentrations ADD CONSTRAINT inp_concentrations_region_id_fkey FOREIGN KEY (region_id) REFERENCES public.regions (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.s3_assets ADD CONSTRAINT s3_assets_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiments (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.tray_configuration_assignments ADD CONSTRAINT fk_tray_assignments_to_tray FOREIGN KEY (tray_id) REFERENCES public.trays (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE public.tray_configuration_assignments ADD CONSTRAINT fk_tray_assignment_to_configuration FOREIGN KEY (tray_configuration_id) REFERENCES public.tray_configurations (id) MATCH SIMPLE ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ddl-end --
-- object: "grant_CU_473897ba7d" | type: PERMISSION --
GRANT CREATE,
USAGE ON SCHEMA topology TO postgres;
