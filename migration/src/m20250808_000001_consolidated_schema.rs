...
impl MigrationTrait for Migration {
    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let mut trays_table = Table::create()
            ...
            // Image coordinate columns for probe positioning (nullable)
            .col(ColumnDef::new(Trays::UpperLeftCornerX).integer().null())
            .col(ColumnDef::new(Trays::UpperLeftCornerY).integer().null())
            .col(ColumnDef::new(Trays::LowerRightCornerX).integer().null())
            .col(ColumnDef::new(Trays::LowerRightCornerY).integer().null())
            .foreign_key(
                ForeignKey::create()
